...
| **4** | **Advanced / competitive** | **XenForo importer ✅ (ADR-0041, clean-room, behind `SourceDriver`)**. DEFERRED (not built — Phase 4 proper): SSO/OAuth2/SAML, paid memberships/subscriptions, Clubs, advanced anti-spam intelligence, **Meilisearch + Reverb** (enhanced tier), PWA/push. |
