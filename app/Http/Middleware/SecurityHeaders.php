 ...
 * response, and HSTS on TLS. All values come from config/hearth.php 'security' and the whole thing is
 * toggleable, so an operator embedding Hearth can relax the policy without editing code.
 *
...
final class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $maxAge = (int) config('hearth.security.headers.hsts_max_age', 0);
