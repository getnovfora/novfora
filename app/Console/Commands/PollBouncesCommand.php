...
/**
 * Spike P2 — `php artisan novfora:deliverability:poll-bounces`. The daemon-free poll path: fetch a bounded
...
{
    protected $signature = 'novfora:deliverability:poll-bounces';
    ...
    {
        if (! config('novfora.deliverability.enabled')) {
            $this->info('Deliverability pipeline is dormant (novfora.deliverability disabled).');
