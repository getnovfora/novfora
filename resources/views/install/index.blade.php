...
<head>
    ...
    {{-- Fully self-contained: the installer must NEVER depend on the app CSS bundle (a fresh upload may not
         ...
         below, on the NovFora brand palette (hearth-cream + Nova Blue). --}}
    ...
    @livewireStyles
    <style>
        :root { --ink:#221c13; --muted:#5c5346; --line:#e6dccb; --accent:#245fbb; --ok:#2b774d; --warn:#8f6207; --bad:#be3a2b; }
        body { font-family: system-ui, -apple-system, Segoe UI, Roboto, sans-serif; color: var(--ink); background:#f4eee2; margin:0; }
        .wrap { max-width: 44rem; margin: 0 auto; padding: 2rem 1rem 4rem; }
        .card { background:#fcfaf4; border:1px solid var(--line); border-radius:16px; padding:1.5rem; }
        ...
        input[type=text], input[type=url], input[type=email], input[type=password], input[type=number], select {
            width:100%; box-sizing:border-box; padding:.5rem .6rem; border:1px solid #d3c6af; border-radius:8px; font-size:1rem; }
        ...
        .btn-ghost { background:#fcfaf4; color:var(--accent); }
        ...
        .note { background:#e5edfb; border:1px solid #cdddf8; border-radius:8px; padding:.6rem .8rem; margin:.6rem 0; font-size:.9rem; }
        table.kv { width:100%; border-collapse:collapse; font-size:.9rem; }
        table.kv td { padding:.3rem .5rem; border-bottom:1px solid var(--line); }
        code { background:#ebe3d3; padding:.1rem .35rem; border-radius:4px; }
    </style>
</head>
<body>
    <div class="wrap">
