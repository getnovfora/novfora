...
php artisan dusk --without-tty tests/Browser/EditorJourneyTest.php tests/Browser/ThemeScreenshotTest.php tests/Browser/AdminJourneyTest.php tests/Browser/ContentDepthJourneyTest.php tests/Browser/PmJourneyTest.php tests/Browser/AccountDeletionJourneyTest.php
EDITOR_CODE=$?
set -e
